...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO premium (full_name, current_weight, height, bmi, age, gender, address, city, phone, email,amount, health_problems)
            VALUES ('$full_name', $current_weight, $height, $bmi, $age, '$gender', '$address', '$city', '$phone', '$email','$amount', '$health_problems')";

    if ($conn->query($sql) === TRUE) {
        echo "<script type='text/javascript'>alert('Premium Plan Registered Successfully...');
